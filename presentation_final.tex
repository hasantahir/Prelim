  ...
  \begin{columns}[T] % align columns
    ...
    \begin{column}[T]{.5\textwidth}
      \begin{figure}
        \vspace*{-2cm}
        \centering
        \subfloat{\def\svgwidth{.75\linewidth}
        \input{figures/2deg_grated_gate.pdf_tex}
        \label{fig:2deg_grated_gate}}
        \hfil
        \subfloat{\def\svgwidth{.75\linewidth}
        \input{figures/2deg_quantum_wire.pdf_tex}
        \label{fig:2deg_quantum}}
